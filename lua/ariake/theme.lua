local c = require("ariake.palette")
...
theme.set_highlights = function()
  ...
  hl(0, "FloatBorder", { fg = c.comment, bg = "NONE" })
  hl(0, "Whitespace", { fg = c.bg, bg = "NONE" })
  hl(0, "WinSeparator", { fg = c.comment, bg = c.alt_bg })
  hl(0, "VertSplit", { link = "WinSeparator" })
  hl(0, "CursorLine", { fg = "NONE", bg = c.dk_purple })
  hl(0, "CursorColumn", { fg = c.blue, bg = c.cyan })
  ...
  hl(0, "MatchParen", { fg = c.warning, bg = c.dk_purple, underline = true })
  ...
  hl(0, "@constructor.tsx", { fg = c.yellow, bg = "NONE" })
  hl(0, "@constructor.javascript", { fg = c.yellow, bg = "NONE" })
  hl(0, "@parameter", { fg = c.green, bg = "NONE", italic = true })
  ...
  hl(0, "@markup.italic", { fg = c.yellow, bg = "NONE", italic = true })
  ...
  hl(0, "@markup.raw.block", { link = "String" })
  ...
  hl(0, "LspDiagnosticsUnderlineError", { fg = "NONE", bg = "NONE", sp = c.error, underline = true })
  hl(0, "LspDiagnosticsUnderlineWarning", { fg = "NONE", bg = "NONE", sp = c.warning, underline = true })
  hl(0, "LspDiagnosticsUnderlineInformation", { fg = "NONE", bg = "NONE", sp = c.info, underline = true })
  hl(0, "LspDiagnosticsUnderlineInfo", { fg = "NONE", bg = "NONE", sp = c.info, underline = true })
  hl(0, "LspDiagnosticsUnderlineHint", { fg = "NONE", bg = "NONE", sp = c.hint, underline = true })
  ...
  -- Dashboard
  hl(0, "DashboardHeader", { fg = c.pink, bg = "NONE" })
  ...
  hl(0, "MiniStatuslineModeInsert", { fg = c.bg, bg = c.dk_pink })
  ...
  hl(0, "MiniTablineModifiedCurrent", { fg = c.warning, bg = c.comment })
  hl(0, "MiniTablineModifiedVisible", { fg = c.warning, bg = c.bg })
  hl(0, "MiniTablineModifiedHidden", { link = "MiniTablineModifiedVisible" })
